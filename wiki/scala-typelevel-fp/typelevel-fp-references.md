...
- **John De Goes** — "The False Hope of Managing Effects with Tagless-Final in Scala" (degoes.net/articles/tagless-horror): the authoritative anti-pattern/alert source on premature indirection, untestable effects, and the parametric-reasoning nuance behind minimal typeclass constraints.
