...
| [Recursion Schemes and the Droste Library](scala-typelevel-fp/recursion-schemes-and-droste.md) | Catamorphism/anamorphism/hylomorphism/histomorphism zoo, droste's Algebra/Coalgebra/Fix/Basis, F-algebra/F-coalgebra grounding, and heuristics for spotting recursion-scheme shape when the structure isn't an obvious tree | 2026-09-07 |
